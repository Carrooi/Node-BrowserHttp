...
(function() {
  ...
  Request = (function() {
    ...
    function Request(url, type, data) {
      ...
      if (this.data !== null) {
        data = this.Http.buildQuery(this.data);
        if (this.type !== 'POST') {
          url = this.url.indexOf('?') !== -1 ? this.url + '&' + data : this.url + '?' + data;
        }
      }
      ...
      this.xhr.onreadystatechange = function() {
        ...
        if (_this.response.state === 4) {
          ...
          if (_this.getHeader('content-type') === 'application/json') {
            _this.response.data = JSON.stringify(_this.response.data);
          }
